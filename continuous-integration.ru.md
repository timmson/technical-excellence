...
Система CI сравнима с культурой «остановить-линию» в Toyota. Когда дефект обнаружен, Toyota останавливает линию, первым приоритетом становится устранение дефекта и его первопричины. Разве многоступенчатая CI-система скрывает дефекты и противоречит этому принципу бережливого производства? Нет. Принцип «останови линию» в действии, но это не значит, что вы должны слепо остановить всю работу. Даже Toyota этого не делает [[LM06a](http://www.amazon.com/Toyota-Way-Fieldbook-Jeffrey-Liker/dp/0071448934)].
...
При построении многоэтапной CI-системы подумайте над:
 ...
 - триггерами по событию или времени
 - количеству этапов
